...
def label_nmea_file_with_indoor_outdoor_labels(nmea_file: Path,
                                               indoor_outdoor_labels: list):
    nmea_file = Path(nmea_file)
...
def process_file(nmea_file: Path, label_result_dir: Path, accel_dir: Path):
    ...
    label_nmea_file_with_indoor_outdoor_labels(nmea_file,
                                               indoor_outdoor_labels)


@click.command()
@click.argument('nmea_path')
@click.argument('label_result_dir')
@click.option('--accel_dir', default=None)
