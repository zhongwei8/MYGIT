...
LastEditTime: 2021-03-04 14:03:38
LastEditors: Please set LastEditors
Description: In User Settings Edit
FilePath: /activity-recognition/src/py/indoor_outdoor_nmea_process.py
'''
import click
...
def preprocess_raw_nmea_file(raw_nmea_file_path: Path, indoor_outdoor_status = 0):
